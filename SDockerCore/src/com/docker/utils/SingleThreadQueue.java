...
public class SingleThreadQueue<T> extends RunnableEx{
	...
	public SingleThreadQueue(String description, ConcurrentLinkedQueue<T> queue, ThreadPool threadPool) {
		this(description, queue, threadPool, null);
	}
	
	public SingleThreadQueue(String description, ConcurrentLinkedQueue<T> queue, ThreadPool threadPool, Handler<T> handler) {
		super(description);
		this.queue = queue;
