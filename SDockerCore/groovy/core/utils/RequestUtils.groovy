...
/**
 * Created by aplombchen on 10/10/16.
 */
public class RequestUtils {
    ...
    public static Integer[] offsetLimitHandler(Integer offset, Integer limit, int defaultLimit, int defaultOffset, int maxRecords) {
        if(offset == null)
...
//			throw new CoreException(CoreErrorCodes.ERROR_EXCEEDED_MAX_RECORDS, "Exceeded the max records : " + maxRecords);
        ...
        return [offset, limit] as Integer;
    }
