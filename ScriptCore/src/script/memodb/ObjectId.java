...
public final class ObjectId implements Comparable<ObjectId>, Serializable {
	private static final String TAG = ObjectId.class.getSimpleName();
    ...
    private static int createMachineIdentifier() {
        ...
        try {
            ...
            LoggerEx.error(TAG, "Failed to get machine identifier from network interface, using random number instead");
        }
    ...
    private static short createProcessIdentifier() {
        ...
        try {
            ...
            LoggerEx.error(TAG, "Failed to get process identifier from JMX, using random number instead");
        }
